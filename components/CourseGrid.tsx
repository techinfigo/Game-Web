                       ...
                       {filteredCourses.map((course) => (
                         ...
                         >
                           <div className="group relative bg-white rounded-[2rem] border border-slate-200 overflow-hidden hover:shadow-2xl hover:shadow-gameTeal/20 transition-all duration-500 h-full flex flex-col">
                             ...
                             <div className="absolute inset-0 bg-[#075d63] opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center p-8 z-30">
                                 <motion.div 
                                 ...
                                 >
                                   <div className="space-y-6">
                                      <p className="text-xs font-black text-[#f2c537] uppercase tracking-widest text-center">Course Highlights</p>
                                      <div className="space-y-4">
                                        {course.features.slice(0, 3).map((feature: string, i: number) => (
                                           <div key={i} className="flex items-center gap-4">
                                              <div className="w-6 h-6 rounded-full border-2 border-[#f2c537] flex items-center justify-center shrink-0">
                                                 <CheckCircle2 size={14} className="text-[#f2c537] fill-transparent" />
                                              </div>
                                              <span className="text-lg font-bold text-white leading-tight">{feature}</span>
                                           </div>
                                         ))}
                                      </div>
                                   </div>
                                   ...
                                   <div className="space-y-4">
                                     <button 
                                       ...
                                       className="w-full py-5 rounded-2xl bg-white text-[#075d63] font-black text-sm uppercase tracking-wider hover:bg-slate-50 transition-colors flex items-center justify-center gap-2 shadow-lg"
                                     >
                                       View Full Details <ChevronRight size={20} />
                                     </button>
                                     <button className="w-full py-5 rounded-2xl bg-[#f2c537] text-slate-900 font-black text-sm uppercase tracking-wider hover:bg-[#d8b32f] transition-all shadow-xl flex items-center justify-center gap-2">
                                       Enroll Now <Zap size={20} className="fill-current" />
                                     </button>
                                   </div>
                                 </motion.div>
                             </div>
